...
function openOrder(id){const o=orders.find(x=>String(x.id)===String(id));if(!o)return;$("orderModalTitle").textContent=(o.order_code ? "MONTÊ-"+o.order_code : (o.order_nsu||"Pedido"));$("orderDetails").innerHTML=orderDetail(o);$("orderModal").classList.remove("hidden")}
